...
export default function List({ setCurrentFile }: TListProps) {
  ...
  return (
    <>
      <div className="mb-6 divide-y divide-[#C3C3C3] overflow-hidden rounded-xl border border-[#C3C3C3]">
    ...
    //           {list.status === "analyzing" && <ProgressBar progress={(0, 0)} />}
    //           {list.status === "loading" && <ProgressBar progress={(0, 0)} />}
    //           {list.status === "success" && <ProgressBar progress={(0, 0)} />}
    //           {list.status === "error" && <ProgressBar progress={(0, 0)} />}
    //         </li>
    //       </>
    //     ))}
    //   </ul>
