  ...
  return (
    <div className="relative flex items-center justify-center">
      <ul className="h-[994px] w-[247px] text-ellipsis rounded-xl border border-line-default bg-white text-2 font-normal leading-[19.36px] text-text-dark">
        ...
        {/* list*/}
        <li
          className={`h-[44px] border-b border-line-light p-[10px] hover:bg-bg-primary_light ${isSelected && "bg-line-light hover:bg-line-light"}`}
          onClick={selectIconVisible}
        >
