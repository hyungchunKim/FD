...
const FileList: React.FC<FileListProps> = ({
  ...
  const getFileStatus = useCallback(
    (item: TRepoContentItem): FileStatus => {
  ...
  const renderDirItem = useCallback(
    (item: TRepoContentItem) => {
    ...
    <div className="flex h-full flex-col">
      ...
      {selectedFiles.length > 0 && (
        <div className="border-t border-gray-200 bg-purple-50 p-4">
          <h3 className="mb-2 text-sm font-semibold">선택된 파일 ({selectedFiles.length})</h3>
